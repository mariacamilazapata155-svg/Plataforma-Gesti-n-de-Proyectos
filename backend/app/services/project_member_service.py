...
def create_new_project_member(
    ...
    existing_member = get_user_membership(db, project_id, member.user_id)

    if existing_member:
        raise ValueError("The user already belongs to the project.")
...
def get_member_by_id(
    ...
    member = get_project_member(db, member_id)
