...
def upgrade() -> None:
    ...
    op.execute("ALTER TYPE notificationtype ADD VALUE IF NOT EXISTS 'BOARD_CREATED';")

    op.execute("ALTER TYPE notificationtype ADD VALUE IF NOT EXISTS 'BOARD_UPDATED';")

    op.execute("ALTER TYPE notificationtype ADD VALUE IF NOT EXISTS 'BOARD_DELETED';")

    op.execute("ALTER TYPE notificationtype ADD VALUE IF NOT EXISTS 'COMMENT_UPDATED';")

    op.execute("ALTER TYPE notificationtype ADD VALUE IF NOT EXISTS 'COMMENT_DELETED';")
